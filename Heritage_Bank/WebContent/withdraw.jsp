...
<div class="container">
    ...
    <form method="post">
        <input type="number" name="amount" placeholder="Enter withdrawal amount" required step="0.01" min="0.01"><br>
    ...
    <%
        if (request.getMethod().equals("POST")) {
            ...
            try (Connection conn = DBConnection.getConnection()) {
                ...
                String getBalance = "SELECT balance FROM users WHERE u_id = ?";
                double currentBalance = 0;
                try (PreparedStatement pstmt = conn.prepareStatement(getBalance)) {
                ...
                if (currentBalance < amount) {
                    ...
                    String insertTransaction = "INSERT INTO transactions (u_id, type, amount, description) VALUES (?, 'WITHDRAWAL', ?, 'Money Withdrawn')";
                    ...
                    conn.commit();
                    out.println("<p style='color:green;'>Withdrawal Successful!</p>");
                }
            } catch (Exception e) {
                e.printStackTrace();
